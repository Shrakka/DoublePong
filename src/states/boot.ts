...
export default class Boot extends Phaser.State {
    ...
    public preload(): void {
        this.game.load.atlasJSONArray(Assets.Atlases.AtlasesLoadbar.getName(), Assets.Atlases.AtlasesLoadbar.getPNG(), Assets.Atlases.AtlasesLoadbar.getJSONArray());
        this.game.load.image(Assets.Images.ImagesAmericanflag.getName(),Assets.Images.ImagesAmericanflag.getPNG());
        this.game.load.image(Assets.Images.ImagesTitle.getName(), Assets.Images.ImagesTitle.getPNG());
    
    // Comment this line next
